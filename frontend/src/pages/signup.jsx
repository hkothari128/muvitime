            ...
            <div className='content'>
                ...
                <div className='m-auto'>
                    ...
                    <div className='form flex flex-col w-[90%] m-auto text-white'>
                        ...
                        <input className='p-4 flex-1 ' type="email" placeholder='Email Address' value={formsValues.email} name='email' onChange={(e)=>{
                            setFormValues({...formsValues,[e.target.name]:e.target.value})
                        }} />
                        {showPassword? 
                        <input className='p-4 flex-1' type="password" placeholder='Password' value={formsValues.password} name='password' onChange={(e)=>{
                            setFormValues({...formsValues,[e.target.name]:e.target.value})
                        }}/> :
                        ...
                        <button onClick={()=>handleSignup()} className='mt-3 rounded-sm border-0 py-2 px-4 mb-1 w-auto mx-auto bg-primary text-white font-semibold'>Sign Up</button>
